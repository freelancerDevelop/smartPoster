<?php
    ...
    class Session {
        ...
        protected static $userClass='Admin', $userTable='admin', $sessionVar='id', $loginPage=LOGIN_PAGE, $userField='username';
        ...
        public static function get_instance() //return session instance
        {
        ...
        public function login($user) //log in a user
        {
            ...
            $_SESSION[self::$sessionVar]=$user->$userField;
            $this->user=$user;
            $this->loggedIn=true;
